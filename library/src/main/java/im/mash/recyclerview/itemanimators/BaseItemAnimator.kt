 ...
 */
abstract class BaseItemAnimator<T> : SimpleItemAnimator() {
     ...
     * @param holder
     */
    internal abstract fun addAnimationCleanup(holder: RecyclerView.ViewHolder)
     ...
     * @param toY
     */
    open fun changeAnimation(oldHolder: RecyclerView.ViewHolder, newHolder: RecyclerView.ViewHolder?, fromX: Int, fromY: Int, toX: Int, toY: Int) {
     ...
     * @return
     */
    abstract fun changeOldAnimation(holder: RecyclerView.ViewHolder, changeInfo: ChangeInfo): ViewPropertyAnimatorCompat
     ...
     * @return
     */
    abstract fun changeNewAnimation(holder: RecyclerView.ViewHolder): ViewPropertyAnimatorCompat
